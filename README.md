...
> **本项目基于上游开源项目 [AAswordman/Operit](https://github.com/AAswordman/Operit) 构建。**
>
> 仅做了以下修改：
> - **UI 颜色**：调整为本人的个人喜好配色
>
> **其他内容未作任何修改**：所有功能特性、构建方式、使用说明、更新日志、许可证等均与上游项目保持一致。
>
> - 如需**最新功能、官方发布版本或技术支持**，请访问上游仓库：[AAswordman/Operit](https://github.com/AAswordman/Operit)
> - 本仓库仅用于个人构建、自用和分享，不构成对上游项目的替代或分发。
